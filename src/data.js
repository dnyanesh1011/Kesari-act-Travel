...
// An array of tour objects, each representing a travel destination with details.
const data = [
	{
	  id: 1,
	  name: "Agra",
	...
	},
	{
	  ...
	  name: "Jaipur",
	  info:
		"Jaipur is the capital city of the Indian state of Rajasthan, known for its stunning pink-hued buildings and palaces. The city is also known as the 'Pink City' due to the color of many of its buildings. Jaipur is famous for its intricate textiles, colorful handicrafts, and delicious cuisine.",
